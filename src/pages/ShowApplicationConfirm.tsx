      ...
      <Card className="mx-auto max-w-5xl overflow-hidden shadow-xl">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            {row('2025 Target', form.target2025)}{row('2025 Sales', form.sales2025)}{row('2026 Target', form.target2026)}
            {row('Submitted', application.submittedAt ? new Date(application.submittedAt).toLocaleString() : '-')}
          </div>
