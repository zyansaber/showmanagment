  ...
  const salesVsCards = [
    {
      ...
      ratioLabel: 'current sales / YTD target',
      color: 'bg-rose-500',
    },
    {
      ...
      ratioLabel: 'current sales / 2025 same period sales',
      color: 'bg-indigo-500',
    },
    {
      ...
      ratioLabel: 'current sales / whole year target',
                  ...
                  return (
                    <div key={metric.label} className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
                      <div className="flex items-start justify-between">
                        <div>
                          <p className="text-lg font-bold text-slate-800">{metric.label}</p>
                        </div>
                        <div className="text-right">
                          ...
                          <p className="text-xs uppercase tracking-wide text-slate-500">{metric.ratioLabel}</p>
                        </div>
                      </div>
            ...
            <CardContent>
              {caravanRangeData.length > 0 ? (
                <ResponsiveContainer width="100%" height={240}>
                  <BarChart data={caravanRangeData} layout="vertical" margin={{ top: 6, right: 24, left: 6, bottom: 6 }}>
