...
export default function Dashboard() {
  ...
  const ringMetrics = [
    { label: 'YTD Target Completion', color: '#ef4444', percent: ytdPercent, radius: 116 },
    { label: '2025 YoY Sales', color: '#6366f1', percent: yoy2025Percent, radius: 88 },
    { label: 'Sales Completion', color: '#10b981', percent: gaugePercent, radius: 60 },
  ];
                ...
                <div className="relative h-[320px] w-[320px]">
                  <svg viewBox="0 0 300 300" className="h-full w-full">
                    {ringMetrics.map((ring) => {
                      ...
                      const textY = 150 - ring.radius - 10;
                      return (
                        <g key={ring.label}>
                          <circle cx="150" cy="150" r={ring.radius} fill="none" stroke="#e2e8f0" strokeWidth="16" />
                          <circle
                            cx="150"
                            cy="150"
                            r={ring.radius}
                          ...
                          />
                          <text x="150" y={textY} textAnchor="middle" fontSize="13" fontWeight="700" fill={ring.color}>
                            {ring.percent}%
                          </text>
                        </g>
                      );
