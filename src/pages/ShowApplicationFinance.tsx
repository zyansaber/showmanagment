...
export default function ShowApplicationFinance() {
  ...
  const save = async (event: FormEvent) => {
    ...
    const show = {
      ...
      layoutAddress: form.layoutAddress,
      sapExpenseCode: form.sapExpenseCode,
      status: 'Not Started',
      teamMembers: [],
    };
    try {
