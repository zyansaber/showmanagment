...
export default function TeamManagement() {
  ...
  const handleSendPortalEmail = async (member: TeamMemberRecord) => {
    ...
    const title = 'Your team member portal';
    const content = [
      `Hi ${member.memberName || 'team member'},`,
      '',
      'Please open your personal team member portal using the link below.',
      '',
      `Portal page: ${portalUrl}`,
    ].join('\n');
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>Manage employee information, roles, and team portal links</CardDescription>
            </div>
