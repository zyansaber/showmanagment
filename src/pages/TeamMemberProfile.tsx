...
export default function TeamMemberProfile() {
  ...
  useEffect(() => {
    ...
    const profileStartUrl = `/team/${encodeURIComponent(decodeURIComponent(memberSlug))}`;
    const profileManifest = {
      name: 'Snowy River Shows',
      short_name: 'Shows',
      description: 'Team member show portal for Snowy River shows.',
      start_url: profileStartUrl,
      scope: '/',
      display: 'standalone',
    ...
    const manifestUrl = URL.createObjectURL(new Blob([JSON.stringify(profileManifest)], { type: 'application/manifest+json' }));
