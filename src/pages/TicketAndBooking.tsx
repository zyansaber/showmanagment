...
type ConfirmRequest = { id: string; showId: string; token: string; requestedAt: string; confirmUrl: string; confirmedAt?: string; participantIds: string[]; confirmedParticipantIds?: string[] };
